  ...
  )
{
  ...
  Private->AhciBaseAddress = Dev->Resources[0].AddrRangeMin;
  Private->IdeInit.AhciBaseAddress = Private->AhciBaseAddress;
  ...
  Private->PciAttributesChanged   = FALSE;
    ...
    //
    Data32 = AhciReadReg (Private->AhciBaseAddress, R_AHCI_PI);
    ...
    //
    Data32 = AhciReadReg (Private->AhciBaseAddress, R_AHCI_CAP);

  ...
  )
{
  ...
  Data = MmioRead8 (Xhc->UsbHcBaseAddress + Offset);
  ...
  )
{
  ...
  Data = MmioRead32 ( Xhc->UsbHcBaseAddress + Offset );
  ...
  )
{
  ...
  Data = MmioRead32 (Xhc->UsbHcBaseAddress + Xhc->CapLength + Offset);
  ...
  )
{
  ...
  MmioWrite32 (Xhc->UsbHcBaseAddress + Xhc->CapLength + Offset, Data);
}
  ...
  )
{
  ...
  Status = MmioWrite32 (Xhc->UsbHcBaseAddress + Xhc->DBOff + Offset, Data);
}
  ...
  )
{
  ...
  Data = MmioRead32 (Xhc->UsbHcBaseAddress + Xhc->RTSOff + Offset);
  ...
  )
{
  ...
  Status = MmioWrite32 (Xhc->UsbHcBaseAddress + Xhc->RTSOff + Offset, Data);
}
  ...
  )
{
  ...
  Data = MmioRead32 (Xhc->UsbHcBaseAddress + Xhc->ExtCapRegBase + Offset);
  ...
  )
{
  ...
  Status = MmioWrite32 (Xhc->UsbHcBaseAddress + Xhc->ExtCapRegBase + Offset, Data);
}
  ...
  )
{
  ...
  XhciCmd = MmioRead16 (Xhc->UsbHcBaseAddress + Xhc->CapLength + XHC_USBSTS_OFFSET);
  if ((XhciCmd & 0x100) != 0) {
